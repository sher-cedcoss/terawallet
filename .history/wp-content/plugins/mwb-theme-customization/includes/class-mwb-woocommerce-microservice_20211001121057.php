...
if( !class_exists( 'MWB_WooCommerce_Microservice' ) )
{
	...
	class MWB_WooCommerce_Microservice{
		...
		public function __construct() {
			...
			add_shortcode('mwb_microservice_related', array( $this, 'mwb_microservice_related_function')
				);
								...
								<div class="mwb_related_service_wrapper">
									...
									<div class="mwb-button">
										...
										// {
											...
											// {
												?>
												<!-- <a class="mwbaddtocartbutton button product_type_simple add_to_cart_button ajax_add_to_cart" href="<?php //echo home_url('/store')?>?add-to-cart=<?php //echo $relatedserviceid;?>" data-quantity="1" data-product_id="<?php //echo $relatedserviceid;?>">Add to Cart</a> -->
												<?php
										// 	}
										// }
										// else
