			...
			<tbody>
				<tr valign="top">
					...
					<td class="forminp forminp-text">
						<input type="checkbox" name="mwb_enable_festive_decoration" value="1" id="mwb_enable_festive_decoration" <?php if(isset($mwb_enable_festive_decoration) && !empty($mwb_enable_festive_decoration)){echo 'checked="checked"';} ?> >					
					</td>
				</tr>
				<tr valign="top">
					<th scope="row" class="titledesc">
