								...
								<div class="mwb-product-wrap__subscription">
									...
									<div class="mwb-product-wrap__subscription-details">
										...
										if(isset($average_rating) && !empty($average_rating))
										{
											...
											<!--<p class="text-right"><i class="fas fa-star"></i> <?php //echo $average_rating; ?> out of 5 Rating</p>-->
											<?php
										}
											...
											if ($product_id !== 27746)
											{
												...
												if($product->is_type('variable')){
													...
													foreach ($children_ids as $children_id) {
														...
														?>
														<div <?php if($variation->is_on_sale() && $i == 2){ echo 'class="mwb-sale-offer-strip-notification"'; }  ?> >
														<?php 
														...
														?>
														<input type="radio" name="variation_id" value="<?php echo $children_id; ?>" id="<?php echo $slug; ?>" <?php if($i==0){ echo 'checked'; } ?> ><label for="<?php echo $slug; ?>"></label><span><?php echo $attribute['license-type']; ?></span> <span class="mwb_new_layout_price_html"><?php echo $variation->get_price_html(); ?> <?php if ( $variation->is_on_sale() ){ ?><span class="mwb_offer_save_price_msg" >(Save $<?php echo $offer_price; ?>)</span><?php  } ?> </span></div>
														<?php
														$i++;
													}
												}
