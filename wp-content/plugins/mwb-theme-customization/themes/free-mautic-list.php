		...
		<article class="post-<?php echo $postid;?> page type-page status-publish entry" itemscope="" itemtype="https://schema.org/CreativeWork">
			<div class="entry-content" itemprop="text">
				<div id="pl-<?php echo $postid;?>" class="panel-layout">
					...
					$args = array(
						...
						'tax_query' => array(
							array(
								...
								'field'    => 'slug',
								'terms'    => 'mautic-templates',
							),
						),
						'meta_query' => array(
							array(
								'key'     => 'mwb_enable_free_product_setting',
								'value'   => serialize(strval('true')),
								'compare' => 'LIKE',
							),
						),
					);
					...
					{
						?>
						<div id="pg-<?php echo $postid;?>-0" class="panel-grid panel-no-style mwbmicroservices mwb_mautic_border_bottom">
							<?php
							while ( $wp_query->have_posts() ) 
							{
								...
								?>
								<div id="pgc-<?php echo $postid;?>-0-0" class="panel-grid-cell mwb_microservice_list_wrapper mwb_free_mautic_email_templates">
										...
										<div class="so-widget-sow-editor so-widget-sow-editor-base">
											<div class="siteorigin-widget-tinymce textwidget">
												<a href="<?php echo get_the_permalink()?>">
													<div class="mwb-mautic-email__img">
														<img src="<?php echo $product_image; ?>" width="" height="" alt="" />
													</div>
													<div class="mwb-mautic-email__content">
														<h2 class="mwbviewservicelisttitle"><?php echo get_the_title();?></h2>
														<div class="mwb_short_desc"><?php echo get_the_excerpt(); ?></div>
		...
		<article class="post-<?php echo $postid;?> page type-page status-publish entry" itemscope="" itemtype="https://schema.org/CreativeWork">
			<div class="entry-content" itemprop="text">
				<div id="pl-<?php echo $postid;?>" class="panel-layout">
					...
					{
						?>
						<div class="mwb_related_premium_templates">
						<h2>You May Also Like Our Premium Templates...</h2>
						</div>
